        ...
        <div class="row justify-content-center">
            <div class="col-lg-5 col-md-7">
                <div class="auth-card">
                    ...
                    <form method="POST" action="{{ route('registerUniversity') }}">
                        @csrf
                        <!-- Name -->
                        <div class="mb-3">
                        ...
                        <!-- Name -->
                        <div class="mb-3">
                            <label for="name" class="form-label">{{ __('University') }}</label>
                            {{-- <input id="university_id" type="text" name="university_id" value="{{ old('name') }}"
                                class="form-control @error('university_id') is-invalid @enderror" required autofocus
                                autocomplete="name"> --}}
                            <select name="university_id" id="university_id" class="form-select" required autofocus
                                autocomplete="university_id">
                                <option value="">OTM ni tanlang</option>
                                @foreach ($universities as $unver)
                                    <option value="{{ $unver->id }}">{{ $unver->title }}</option>
                                @endforeach
                            </select>
                            @error('university_id')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <a class="link-muted" href="{{ route('loginUniversity') }}">
